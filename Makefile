-include .env ## importing .env file

# this .PHONY keyword tells make to treat all of these commands as a commands not files
...
inspect-thunderloan:; forge inspect ThunderLoan storage